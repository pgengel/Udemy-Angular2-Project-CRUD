System.register(['angular2/core', 'angular2/http', './photo.service', 'angular2/router'], function(exports_1, context_1) {
    ...
    var core_1, http_1, photo_service_1, router_1, router_2;
    var AlbumsComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            AlbumsComponent = (function () {
                function AlbumsComponent(_photoService, _routeParams) {
                ...
                AlbumsComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [photo_service_1.PhotoService, router_2.RouteParams])
                ], AlbumsComponent);
